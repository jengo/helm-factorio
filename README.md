...
This chart creates a single [Factorio Headless](https://www.factorio.com/download-headless) Pod, plus Services for the Factorio server and RCON.  It has been forked from the original offical chart https://github.com/helm/charts/tree/master/stable/factorio which hasn't been updated since 0.15.x.
...
$ helm install --name my-release \
  --set factorioServer.factorioServer=My Server,ImageTag=0.17.79 \
    stable/factorio
```

The above command deploys Factorio dedicated with a server name of `My Server` and docker-factorio image version `0.17.79`.
